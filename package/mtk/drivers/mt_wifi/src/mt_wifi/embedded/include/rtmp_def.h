...
#define MAX_APCLI_NUM_PER_BAND		2
#define MAX_APCLI_NUM				0
#ifdef APCLI_SUPPORT
#undef MAX_APCLI_NUM
#ifdef DBDC_MODE
#define MAX_APCLI_NUM_DEFAULT		(MAX_APCLI_NUM_PER_BAND * DBDC_BAND_NUM)
#else
#define MAX_APCLI_NUM_DEFAULT		MAX_APCLI_NUM_PER_BAND
#endif
...
#define MAX_MULTI_STA   ((MAX_APCLI_NUM > 2) ? MAX_APCLI_NUM : 2)
